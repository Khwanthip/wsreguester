...
public class ServerTimeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Thip</title>");            
            out.println("</head>");
            out.println("<body>");
            
            out.println("<h1><center>My Server Time" + "</center></h1>");
            out.println("<h2><center>Date : " + getDate() + "</center></h2>");
            out.println("<h3><center>Date Time : " + getDateTime() + "</center></h3>");
            out.println("<h4><center>Time : " + getTime() + "</center></h4>");
            
            //call sayHello web services
            HelloRequest h = new HelloRequest();
            h.setName("Khwanthip Phuwadonrangsan");
